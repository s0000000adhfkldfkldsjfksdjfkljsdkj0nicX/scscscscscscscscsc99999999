...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ws..":NameBot:") or "سونيك"
...
usernn = data.username_ or "r00t94"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "r00t94"
end
Name = Name:gsub('[[][]]','')
...
message = message ..i.. '-l ['..info.username..'](t.me/r00t94) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/r00t94) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/r00t94) l » (`' ..v.. '`) \n'
end
end
end
...
if UserID == 1614375843 or UserID == 1399282735 then return sendMsg(ChatID,MsgID,"⌯ لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
