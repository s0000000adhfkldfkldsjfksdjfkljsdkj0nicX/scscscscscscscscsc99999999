...
local inline = {{{text="Source Channel : hill",url="T.ME/SourceHell"}}}
send_key(msg.sender_user_id_,'  [Source : hill ](T.ME/SourceHell)',nil,inline,msg.id_)
return false
end
...
{text = 'CHANEL SOURCE', url=callback_data=msg.sender_user_id_.."t.me/sourcehill"},{text = 'DEV', url=callback_data=msg.sender_user_id_.."t.me/xb_0b"},
},
}
...
elseif Text== "باسل" or Text== "hell" or Text== "Hell" or Text== "HELL" or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[STORM SYSTEM](HTTPS://T.ME/R00T94)")
