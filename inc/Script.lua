...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="/help" or MsgText[1]=="اوامر الملفات") and redis:get(ws..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
elseif Text== "باسل" or Text== "hell" or Text== "Hell" or Text== "HELL" or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[STORM SYSTEM](HTTPS://T.ME/xb_0b")
