...
message = message..' ['..info.username..'](T.ME/r00t94)  \n'
...
elseif UserID == 1614375843 or UserID == 1399282735 then  
...
if UserID == 1614375843 or UserID == 1399282735 then return sendMsg(msg.chat_id_,msg.id_,"⌯  لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
local inline = {{{text="Source Channel : sonic",url="T.ME/r00t94"}}}
send_key(msg.sender_user_id_,'  [Source : sonic ](T.ME/r00t94)',nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "سونيك" or MsgText[1]=="سونيك" then
local inline = {{{text="Source Channel : sonic",url="T.ME/r00t94"}}}
send_key(msg.sender_user_id_,'  ملك التلجرام ⚡',nil,inline,msg.id_)
end
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/حط هنا الرو/main/plugins/"..FileName)
if res == 200 then
...
elseif Text== "hell" or Text== "سونيك" or Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/r00t94)")
