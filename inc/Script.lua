...
return '⚶ اصدار سورس الجحيم : *v'..version..'* \n✮'
end
...
sendMsg(arg.chat_id_,arg.id_,'⌯ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الجحيم يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n✮')
end  
else
